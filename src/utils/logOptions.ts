import { Logger, autoLogEnd } from '@promisepending/logger.js';
 ...
 * @private
 */
export function logOptions(defaultOptions: IClientOptions, options: IClientOptions): Promise<[IClientOptions, Logger]> {
